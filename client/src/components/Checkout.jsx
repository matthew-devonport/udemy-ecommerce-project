    ...
    render() {
        ...
        return (
            <Container>
                ...
                {/* Confirmation Modal  */}
                {modal && (
                    <ConfirmatonModal orderProcessing={orderProcessing} cartItems={cartItems} closeModal={this.closeModal}
...
const ConfirmatonModal = ({orderProcessing, cartItems, closeModal, handleSubmitOrder}) => (
    <Modal
